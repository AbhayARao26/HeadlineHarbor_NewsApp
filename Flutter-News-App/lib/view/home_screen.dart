    ...
    return  Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            Text('Headline' , style: GoogleFonts.poppins(fontSize: 24 , fontWeight: FontWeight.w700),),
            Text('Harbor', style: GoogleFonts.poppins(fontSize: 24 , fontWeight: FontWeight.w700, color: Colors.blue),),
          ],
        ),
        actions: [
